myApp.controller("danhsachCategoryProductController", ['$scope', '$http', '$window', 'CategoryProduct', 'MenuMultiLevel', 'uiGridConstants', function ($scope, $http, $window, CategoryProduct, MenuMultiLevel, uiGridConstants) {
    $scope.category = {};
    $scope.categories = [];
    $scope.gridOptions = {};
